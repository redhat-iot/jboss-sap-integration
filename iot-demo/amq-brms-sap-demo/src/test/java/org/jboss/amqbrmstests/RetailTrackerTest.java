...
public class RetailTrackerTest {
	...
	private static String[] specialDepts = new String []{"PHARMACY","FOOD","APPAREL"};
	 ...
	 @BeforeClass
	    public static void setup() throws FileNotFoundException {
	        ...
	        kSession.setGlobal("specialDeptList", Arrays.asList(specialDepts));
	    }
	 
	@Test
    public void testCustomerInDepartment() {
        System.out.println("** Check if customer is in a department with 3 moves and designate as entered **");
